...
public class EnumaPaidType extends Base {
	WebDriver driver ;
	// String baseUrl = "http://sethuonline.com/lms";
	 ...
	 @Given("^User enters the url into the chrome browser3$")
		...
		public void Login() throws Throwable {
			...
			public void PaidType() throws Throwable {
			       
				driver.findElement(By.xpath("//li[@id='menu-item-8148']"));
				
				Actions action = new Actions(driver);
				WebElement Paid = driver.findElement(By.xpath("//li[@id='menu-item-8148']"));
				action.moveToElement(Paid).perform();
		        
				System.out.println("courses successfully");
				//driver.manage().timeouts().implicitlyWait(6000, TimeUnit.SECONDS);
				Thread.sleep(10000);
				
				driver.findElement(By.xpath("//li[@id='menu-item-8144']")).click();
			...
			public void PageDisplay() throws Throwable {
				Assert.assertTrue(driver.getTitle().contains("Become a PHP Master and Make Money Fast")); 	
